...
from bot import APP_VERSION, ai_messages, app_url, normalize_places, normalize_reminders, normalize_reminder_tasks, places_request, pop_capture, parse_ai_json, reminder_events, remember_capture, validate_init_data
